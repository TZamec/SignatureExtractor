...
public class Point3D {
        ...
        public Point3D(Point point) {
            this((double)point.x,(double)point.y,0.0d);
        }
        ...
        /**
         * pricte scalary k bodu
         * @param x
         * @param y
         * @param z
         * @return nova instance bodu
         */
        public Point3D add(int x,int y, int z) {
            return this.add(new Point3D (x,y,z));
        }
        ...
        public static Point3D mull(int x,int y, Mat4 matice) {
            return new Point3D(x, y, 0.0d).mul(matice);
        }

    @Override
    public String toString() {
        return MessageFormat.format("Bod x: {0}, y: {1}, z:{2}",x,y,z);
    }
    /**
     *
     * @return
